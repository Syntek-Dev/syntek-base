...
[![Version](https://img.shields.io/badge/version-7.2.3-blue.svg)](CHANGELOG.md)
...
| [Conventional Commits 1.0.0](https://www.conventionalcommits.org/en/v1.0.0/)                         | Breaking-change signalling in `project-management/docs/git/COMMITS.md` — the `!` shorthand, the `BREAKING CHANGE:` footer, and the `fix`→PATCH / `feat`→MINOR / any-breaking-change→MAJOR mapping. The commit format itself was already in use here; what is derived is how a commit **declares** that it breaks something                                                                                                                                                                                                                                                                                 | CC BY 3.0    |
...
_Maintained by Syntek Studio · v7.2.3 · British English (en_GB) throughout_
