...
│       ├── audit-playwright-pin.yml     ← eight sites declare the Playwright pin; all must name one release
...
| `playwright-pin.sh`    | Eight sites declare the Playwright pin - checks they agree with each other, never the host     |
