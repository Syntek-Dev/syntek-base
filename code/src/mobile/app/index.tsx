 ...
 *
 * The five values below carry `token-allow` because the token module does not exist in
 * the template baseline: it is emitted from the design-token database, which a generated
 * project builds (`code/docs/design-tokens/MOBILE.md`). They exist so the skeleton boots,
 * not because they are the design. Replace each with a token import as the first real
 * screen lands, and delete the annotations — `code/src/scripts/audits/mobile-tokens.sh`
