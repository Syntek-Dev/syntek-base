...
- [ ] GDPR compliance review in `project-management/workflows/09-gdpr-compliance/` is complete
- [ ] Data flows are understood and documented in `project-management/src/09-GDPR/DATA-INVENTORY.md`
