...
- `project-management/src/20-REFACTORING/` — where refactoring notes are saved
- `project-management/workflows/19-implementation-documentation/` — **how work reaches this
  ...
  `src/20-REFACTORING/` and become the input for a refactor. There is no PM-layer refactor
