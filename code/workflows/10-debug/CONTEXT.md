...
builds, network issues) use `how-to/workflows/08-debugging/`. Both workflows are
...
- `how-to/workflows/08-debugging/` — operational debugging (logs, containers, runtime errors)
