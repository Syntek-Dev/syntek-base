...
| [`data-structures/ANTI-PATTERNS.md`](data-structures/ANTI-PATTERNS.md)         | All 11 anti-patterns: God Dictionary, Stringly Typed, Primitive Obsession, Parallel Collections, Nested Dicts, Mega-Model, Implicit Schema, CSV Columns, Boolean Blindness, Overloaded Status, ID-or-Instance Parameter |
