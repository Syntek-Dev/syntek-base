...
├── FORWARD-VOICE.md         ← what a shipped doc may claim about the tree it is read in; the register and the token
...
├── DOCUMENTATION-LENGTH.md  ← the 300-line instructional limit, the 270 ratchet, the dated allowance
...
| `GATE-REPORTING.md`             | **"Could not look" is never reported as "looked, and it was clean"** — absent tool vs absent surface, and the idiom each gate family uses                                                                                                                                                                                                                                  |
| `FORWARD-VOICE.md`              | **What a shipped document may claim about a tree it will be read in** — the two directions, the `how-to/src/PROJECT-PATHS.md` register and the `template-only` token                                                                                                                                                                                                       |
...
| `DOCUMENTATION-LENGTH.md`       | Instructional file length — the 300 code-line limit, what is bound and what is exempt, the 270-line ratchet and its dated `docs-length-allow` comment. Gated by `audits/docs-length.sh`, never `cloc.sh`                                                                                                                                                                   |
