...
**Claude Model:** opus — Testing strategy index: backend, frontend, API, coverage, taxonomy

Sub-documents for testing strategies. Covers taxonomy, backend testing, template/HTMX testing, Django Ninja API testing, advanced techniques, coverage thresholds, and test running guides.
...
Parent guide: `code/docs/TESTING.md`
