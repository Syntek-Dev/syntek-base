...
`../16-STORY-PLANS/` — the master a developer actually codes from. Do **not** duplicate
...
The specs in scope for this sprint. Each story's **story plan** (`../16-STORY-PLANS/`)
...
| Decisions          | `../14-DECISIONS/ADR-{###}-{TITLE}.md` (ADRs this sprint must honour)                         |
| **Story plans**    | `../16-STORY-PLANS/STORY-PLAN-US{###}-*.md` — **the code master for each story**              |
...
Per-story implementation depth lives in `../16-STORY-PLANS/`, **not** in this plan. Before
...
| Story   | Story plan (`../16-STORY-PLANS/`) | Status ({Draft / Ready / In Progress / Done}) |
| ------- | --------------------------------- | --------------------------------------------- |
