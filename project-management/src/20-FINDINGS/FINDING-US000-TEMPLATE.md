...
hard-to-reverse trade-off; graduate to `../15-DECISIONS/`) · `Accepted — {reason}` (a
...
- `project-management/workflows/22-implementation-documentation/` — where this is written
