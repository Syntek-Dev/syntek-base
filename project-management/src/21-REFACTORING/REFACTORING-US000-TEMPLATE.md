...
| **Story plan**      | [`../16-STORY-PLANS/STORY-PLAN-US###-<DESCRIPTOR>.md`](../16-STORY-PLANS/)   |
...
(`../16-STORY-PLANS/STORY-PLAN-US###-*.md`). Name the **motivation type** and the concrete
...
| [EXAMPLE] Review note               | `../18-REVIEWS/REVIEW-US###-<DESCRIPTOR>.md` flagged {concern} |
...
- [`../16-STORY-PLANS/STORY-PLAN-US###-<DESCRIPTOR>.md`](../16-STORY-PLANS/) — the code master
- [`../18-REVIEWS/`](../18-REVIEWS/) — the review that may have flagged the refactor
