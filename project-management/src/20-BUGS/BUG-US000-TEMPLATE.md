...
| **Story plan**   | `../16-STORY-PLANS/STORY-PLAN-US###-<DESCRIPTOR>.md` |
...
- **Related records:** _[EXAMPLE] `../18-REVIEWS/REVIEW-US###-<DESCRIPTOR>.md` · `../17-TESTS/US###-TEST-STATUS.md`_.
...
- `../16-STORY-PLANS/STORY-PLAN-US###-<DESCRIPTOR>.md` — the code master the fix closes the loop on
