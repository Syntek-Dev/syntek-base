...
becomes a feedback item into `../../01-STORIES/US###.md` **before** the sprint plan locks
...
- **[EXAMPLE] Consent** — {consent control unticked by default; label states purpose,
  lawful basis, and retention}; cross-ref `../../08-GDPR/PLANNING/GDPR-PLAN-US###-*.md`.
...
- `../../01-STORIES/US###.md` — the story whose acceptance criteria this plan tests and
  feeds back into
- `../../07-WIREFRAMES/` — the wireframe the scenarios are derived from
- `../../08-GDPR/PLANNING/` · `../../09-SECURITY/` — the GDPR and security constraints
  this plan cross-checks
- `project-management/docs/QA-GUIDE.md` — the governing QA guide
- `project-management/workflows/10-qa-checks/` — the workflow that produces this plan
