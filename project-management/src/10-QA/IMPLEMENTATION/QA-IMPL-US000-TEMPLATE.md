...
- [ ] Manual testing sign-off (see `../../16-TESTS/US###-MANUAL-TESTING.md`)
...
- `../../16-TESTS/US###-TEST-STATUS.md` · `US###-MANUAL-TESTING.md` — downstream test records
- `../../17-REVIEWS/` — code-review notes from the same PR
- `project-management/docs/QA-GUIDE.md` — QA planning and test documentation standards
- `project-management/workflows/20-pr-and-review/` — where this review is written
