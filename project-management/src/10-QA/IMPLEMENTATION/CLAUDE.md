...
# CLAUDE.md — src/10-QA/IMPLEMENTATION/
...
- **Routing:** written during `project-management/workflows/20-pr-and-review/`, once the
...
- Downstream automated status and manual guides live in `../../16-TESTS/`; code-review
  notes in `../../17-REVIEWS/` — do not duplicate them here.
