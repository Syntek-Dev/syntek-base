# project-management/src/10-QA/IMPLEMENTATION
...
Write a review during `project-management/workflows/20-pr-and-review/`, once a story's
...
- `../../01-STORIES/` — the user stories under review
- `../../16-TESTS/` · `../../17-REVIEWS/` — downstream test status and code-review notes
