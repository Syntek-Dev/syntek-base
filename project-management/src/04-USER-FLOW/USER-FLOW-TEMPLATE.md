...
<!-- Filename: USER-FLOW-<AREA>.md — one flow narrative per primary interaction area
     ...
     template, fill every section, and save it to project-management/src/04-USER-FLOW/.
...
<!-- Cross-link the Django Ninja operations that back this flow (12-API-DESIGN). Remove if none. -->

| Document                                                                  | Operations                   |
| ------------------------------------------------------------------------- | ---------------------------- |
| [`API-US###-<descriptor>.md`](../12-API-DESIGN/API-US###-<descriptor>.md) | `[operation]`, `[operation]` |

---

## Security Mitigations

<!-- Findings that shape this flow, from 09-SECURITY. Remove if none apply. -->
...
<!-- Every flow that touches personal data needs this block (08-GDPR). Remove only if the
...
- [ ] [PII field flagged and classified in 08-GDPR]
