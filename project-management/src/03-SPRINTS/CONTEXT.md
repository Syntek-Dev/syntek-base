...
`15-SPRINT-PLANS/`. `SPRINT-00-TEMPLATE.md` is the template; copy it for every new sprint.
...
detailed execution plan lives in `15-SPRINT-PLANS/`. Full scaffold: `SPRINT-00-TEMPLATE.md`.
...
blocker). Detailed planning continues in `15-SPRINT-PLANS/`.
