# project-management/src/13-API-DESIGN/PLANNING
...
served by the per-story designs, as in 09-GDPR).

## When to write one

- When a story introduces or changes any admin API endpoint (GET/POST/PATCH/DELETE)
- When running `project-management/workflows/13-api-design/`
...
- `../CONTEXT.md` — the 13-API-DESIGN folder overview and the per-story API lifecycle
- `../../02-STORIES/` — the story whose Ninja contract this design fixes
- `../../04-DATABASE/` — the agreed schema a design exposes
