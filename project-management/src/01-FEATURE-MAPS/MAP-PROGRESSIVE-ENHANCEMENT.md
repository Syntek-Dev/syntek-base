...
**Status**: Charting
**Frontier open**: 17 · **Blocking open**: 3 · **Resolved**: 8 · **Reopened**: 2 (N-025, N-026)
...
**N-006 is reopened as N-026, 21/08/2026**: the no-ADR decline rested on `15-DECISIONS/` shipping
to generated projects. It does not — `copier.yml:131` excludes it and a probe ADR was proved not
to travel. The decline may still be right; its stated reason is not.
...
Spawned N-025.
**Takeable now:** N-010, N-017, N-019, N-022, N-024, N-025, N-026.
...
| Standing preferences     | ~~**No ADRs in this repo**~~ **under review — N-026** · Tier A · one guide owns the ladder · a rule ships with a gate · Chromium + WebKit   |
| Umbrella ADRs            | ~~**None, by constraint.**~~ **None, by preference** — the constraint was measured false 21/08/2026. See N-026                              |
...
| N-006 | ~~**No ADR.**~~ **REOPENED as N-026, 21/08/2026** — the outcome may stand, but its stated reason (`15-DECISIONS/` ships) was measured false. The Tier A exception mechanism is unaffected                            | grilling | 15/08/2026 | **superseded by N-026**; the exception grep still → **N-016**  |
...
| N-026 | **Reopen N-006 — does the no-ADR decline survive?** Its mechanical premise was measured false 21/08/2026: `15-DECISIONS/` **is** copier-excluded, proved by probe. Decide whether the decline stands on the house-pattern grounds alone, and whether that reaches the four other maps citing the same reason | grilling | none — **takeable**                    | no                |
...
**The takeable edge — seven nodes, nothing in flight.** All three research nodes have returned.
...
| **F** | N-019, N-026                           | **Standalone and takeable immediately.** Pure correction of statements that are false today; depends on nothing and blocks nothing. N-026 joined 21/08/2026 — same class, a claim this map makes about itself rather than about the stack |
...
| Ruled out                                                                          | Why                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~**Any ADR**~~ **PREMISE FALSIFIED 21/08/2026 — reopened as N-026**               | ~~`15-DECISIONS/` ships; an ADR here renders into every generated project or dangles as a cited path that is not there. Standing constraint~~ **Measured false.** `copier.yml:131` excludes `/project-management/src/**` recursively and re-includes only `**/CONTEXT.md`, `**/CLAUDE.md` and `**/*TEMPLATE*`; a probe `ADR-001-*.md` was proved not to travel through a real `copier copy` on 21/08/2026. Kept in this table, struck rather than deleted, so the reversal is legible |
...
- [ ] ~~Every open `GAPS.md` / `DEFERRED.md` entry triaged — both registers empty, recorded~~
      **STALE 21/08/2026** — true when charted; a `GAPS.md` entry dated 20/08/2026 has since been
      added. Step 2 of `workflows/01-feature-map/` must be re-run before any story is cut
- [x] Nothing claimed; neither register file edited here
- [x] Every knowable decision is a node or in fog of war
- [x] Every node typed and blocker-wired; nothing in flight, **seven** nodes takeable now
- [ ] **Every node marked blocking is resolved** — 3 open (N-011, N-012, N-024). N-026 is
...
the true critical path. Batches **F** (N-019, N-026), **G** (N-022) and nodes **N-010**, **N-017**,
