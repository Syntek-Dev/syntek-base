...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Human-corrected at the end  | `22-implementation-documentation` — its _Update Touched Context and Documentation_ step, the "documentation hard gate" |
| Machine-regenerated         | `22-implementation-documentation` — its _Refresh the Code-Review-Graph_ step, docs ⇄ graph lockstep                    |
...
<!-- UPDATED 09/09/2026. The first two rows above cited workflow 22 by step number, "Step 5" and
     "Step 6". Workflow 22 gained a new Step 4 — the two `src/18-TESTS/` test records — on
     09/09/2026, and those steps became 6 and 7. The numbers are replaced by the step names, so
     the citation cannot drift again; the claim itself is unchanged. -->
