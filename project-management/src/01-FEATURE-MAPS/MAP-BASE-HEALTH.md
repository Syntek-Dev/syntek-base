...
**Frontier open**: 11 · **Blocking open**: 0 · **Resolved**: 49 — recounted from the tables
21/08/2026 after **sitting 3** settled **N-054**, **N-048** and **N-020**:
**11 + 49 = 60 = N-060**. Per batch: A 0 · B 3 · D **1** · E **4** · unbatched 3.
...
**11 open at 21/08/2026, after sitting 3 — the current reading is the header block above, and
