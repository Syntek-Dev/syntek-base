...
**Frontier open**: 6 · **Blocking open**: 0 · **Resolved**: 54 — recounted from the tables
23/08/2026 after **sitting 6** settled **N-060**:
...
- [x] **Every node marked "blocking a story" is resolved** — **regressed and restored on
      ...
      **N-032**, which gated not story-writing but _producing a project at all_; **re-ticked the
      ...
      non-blocking by their own wiring (**recounted a twelfth time 23/08/2026** after sitting 6
...
- [x] Every resolved node links to the artefact it became — all **54** carry a commit, a script, a standing limitation, or
      ...
      **34**. Two settlements, no recount, exactly the failure the rule names. **Charting N-047 to
      ...
      the third sitting running: **6 + 54 = 60 = N-060**)
