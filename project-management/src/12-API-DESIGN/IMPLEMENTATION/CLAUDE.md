...
# CLAUDE.md — src/12-API-DESIGN/IMPLEMENTATION/
...
- **Routing:** written during `project-management/workflows/20-pr-and-review/`, after the
  feature's Ninja API ships and before it moves to `../../16-TESTS/`, against the story's
