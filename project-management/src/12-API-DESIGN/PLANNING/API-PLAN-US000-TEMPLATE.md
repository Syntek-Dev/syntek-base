...
- `../IMPLEMENTATION/API-IMPL-US000-TEMPLATE.md` — the post-implementation verification of
  this contract
- `../../01-STORIES/{US###}.md` — the story this design serves (add an `### API Design`
  section there referencing this file)
- `../../03-DATABASE/` — the agreed schema this contract exposes
...
- `project-management/workflows/12-api-design/` — the workflow that produces this design;
  it feeds `project-management/workflows/17-api-code/`
...
- [ ] Database schema signed off for the affected tables (`../../03-DATABASE/`)
