...
| `IMPLEMENTATION/` | After the code phases, before the PR is raised      | `workflows/22-implementation-documentation/` |
...
- `project-management/workflows/22-implementation-documentation/` — writes the `IMPLEMENTATION/` review
- `project-management/workflows/23-pr-and-review/` — verifies it before the merge
