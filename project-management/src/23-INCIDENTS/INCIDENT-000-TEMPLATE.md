...
output and, where it produced a defect, in `../21-BUGS/`._
...
| ----------------- | ---------------- | --------------------------------------------- | ------ |
| _[EXAMPLE] {fix}_ | _{agent / role}_ | _`../21-BUGS/BUG-<DESCRIPTOR>-DD-MM-YYYY.md`_ | _Open_ |
| _[EXAMPLE] {gap}_ | _{agent / role}_ | _`GAPS.md`_                                   | _Open_ |

Homes: a defect → `../21-BUGS/` · an architectural gap or blocker → `GAPS.md` · work deferred to a
...
- [`../21-BUGS/`](../21-BUGS/CONTEXT.md) — where a defect the incident surfaced is recorded
- [`code/docs/security/MONITORING-AND-INCIDENT.md`](../../../code/docs/security/MONITORING-AND-INCIDENT.md)
