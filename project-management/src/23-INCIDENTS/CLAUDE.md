...
- **Concrete steps:** copy `INCIDENT-000-TEMPLATE.md` →
  ...
  `INCIDENT-INDEX.md`** → route every follow-up to a real home (`../21-BUGS/`, `GAPS.md`,
...
- **An entry is not a bug report.** A defect the incident surfaced gets its own
  `../21-BUGS/BUG-*.md` with a regression test; this folder records the outage, not the patch.
