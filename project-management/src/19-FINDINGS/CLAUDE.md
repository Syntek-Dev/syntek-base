...
- **Concrete steps:** copy `FINDING-US000-TEMPLATE.md` →
  ...
  (`../02-STORIES/US###.md`) and its plan (`../16-STORY-PLANS/STORY-PLAN-US###-*.md`) →
...
- **Record, never fix.** A findings record states the smallest fix; it does not apply it.
  The fix lands in a later story, a `../20-BUGS/` report, or `../21-REFACTORING/`.
