...
- **User flow(s):** {`../../../04-USER-FLOW/USER-FLOW-<AREA>.md`}
- **Wireframe(s):** {`../../../07-WIREFRAMES/SCREENS/WF-###-<SCREEN>.html`}
...
- `../../../01-STORIES/` — the story being modelled · `../../../04-USER-FLOW/` ·
  `../../../07-WIREFRAMES/`
- `project-management/docs/SECURITY-GUIDE.md` — STRIDE / OWASP Top 10 / NIST CSF 2.0 reference
- `project-management/workflows/09-security-checks/` — the workflow that produces this model
