...
# CLAUDE.md — src/09-SECURITY/THREAT-MODEL/PLANNING/
...
- **Routing:** models are produced by `project-management/workflows/09-security-checks/`
  using the `security` agent (Fable), analysing a story in `../../../01-STORIES/` and its
  `../../../04-USER-FLOW/` and `../../../07-WIREFRAMES/` artefacts against
