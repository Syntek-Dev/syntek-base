# project-management/src/09-SECURITY/ASSESSMENTS/IMPLEMENTATION
...
Write a record during `project-management/workflows/20-pr-and-review/` (or the
`workflows/09-security-checks/` review step) once a story's code has shipped and the
