...
# CLAUDE.md — src/08-GDPR/PLANNING/
...
- **Routing:** plans are produced by `project-management/workflows/08-gdpr-compliance/`
  using the `gdpr` agent (Fable), analysing a story in `../../01-STORIES/` against
