...
| **Story doc**    | `../01-STORIES/US###.md`                             |
| **Story plan**   | `../15-STORY-PLANS/STORY-PLAN-US###-<DESCRIPTOR>.md` |
...
- **Related records:** _[EXAMPLE] `../17-REVIEWS/REVIEW-US###-<DESCRIPTOR>.md` · `../16-TESTS/US###-TEST-STATUS.md`_.
