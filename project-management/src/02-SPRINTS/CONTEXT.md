# project-management/src/02-SPRINTS
...
`14-SPRINT-PLANS/`. `SPRINT-00-TEMPLATE.md` is the template; copy it for every new sprint.
...
detailed execution plan lives in `14-SPRINT-PLANS/`. Full scaffold: `SPRINT-00-TEMPLATE.md`.
