...
folder along in `14-SPRINT-PLANS/`.

## How to work here

- **Routing:** never write here free-hand — start from
  `project-management/workflows/02-sprint-planning/` (`STEPS.md` + `CHECKLIST.md`),
  governed by `docs/SPRINT-PLANNING-GUIDE.md`. Use `sprint` to organise stories into a
...
- **High-level records only** — detailed plans belong in `14-SPRINT-PLANS/`; do not
  duplicate them here.
