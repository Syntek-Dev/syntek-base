...
- **Story plan:** `../15-STORY-PLANS/STORY-PLAN-US###-{DESCRIPTOR}.md` — the code master this guide exercises
...
- `../15-STORY-PLANS/STORY-PLAN-US###-{DESCRIPTOR}.md` — the implementation plan this guide exercises
