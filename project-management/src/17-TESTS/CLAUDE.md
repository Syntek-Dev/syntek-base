...
- **Routing:** these are implementation records, written during the **code / PR phase** —
  ...
  `project-management/workflows/22-pr-and-review/`, and revisited by the debug and refactor
...
- **Concrete steps:** identify the `US###` → copy `US000-TEST-STATUS.md` and
  ...
  (`../16-STORY-PLANS/STORY-PLAN-US###-*.md`) → append the update date.
