...
- **Story plan:** `../16-STORY-PLANS/STORY-PLAN-US###-{DESCRIPTOR}.md` — the code master this record closes the loop on
...
- `../16-STORY-PLANS/STORY-PLAN-US###-{DESCRIPTOR}.md` — the implementation plan this record closes
