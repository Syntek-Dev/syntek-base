...
- **Story plan:** `../16-STORY-PLANS/STORY-PLAN-US###-{DESCRIPTOR}.md` — the code master this guide exercises
...
- `../16-STORY-PLANS/STORY-PLAN-US###-{DESCRIPTOR}.md` — the implementation plan this guide exercises
