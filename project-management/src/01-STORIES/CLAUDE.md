...
- **Routing:** never write a story free-hand — start from
  `project-management/workflows/01-story-creation/` (`STEPS.md` + `CHECKLIST.md`), or
...
- **Definition of done:** story named `US###.md`, carries an `**Epic:**` line, acceptance
  criteria present; cross-links to `../16-TESTS/US###-*` and `../10-QA/PLANNING/QA-PLAN-US###-*`
