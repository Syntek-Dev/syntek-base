...
# CLAUDE.md — src/08-WIREFRAMES/SHARED/
...
- **Shared palette.** Keep the hex values in step with
  `../../06-BRAND-GUIDE/guide-build/brand_guide.py` and
  `../../07-COMPONENTS/component-build/components.py` so the family stays one system.
