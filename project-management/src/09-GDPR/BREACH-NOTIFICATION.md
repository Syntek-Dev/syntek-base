...
**Broader incident response:** this procedure covers the data-protection notification duties of a personal-data breach; for the organisation's wider security incident-response plan (roles, escalation, communications), see `../10-SECURITY/`.
