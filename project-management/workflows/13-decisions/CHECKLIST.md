...
> (src/13-DECISIONS/) · `src/13-DECISIONS/CLAUDE.md` (authoring rules) ·
> `src/13-DECISIONS/ADR-000-TEMPLATE.md` (the five-section scaffold) for supporting
> references.
...
- [ ] `src/13-DECISIONS/` was scanned for an existing ADR this one might supersede
