...
> **See** `project-management/REFERENCES.md` → **Internal — Guides** (PLANNING-GUIDE.md) · **External — Agile & Project Management** (MoSCoW, Definition of Done) · **Internal — Live Artefacts** (src/15-SPRINT-PLANS/) for supporting references.
...
- [ ] Sprint plan document created: `SPRINT-PLAN-##.md` in `project-management/src/15-SPRINT-PLANS/`
...
- [ ] Ready to proceed to `workflows/16-story-plans`
