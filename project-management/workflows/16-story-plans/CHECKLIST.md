...
> **See** `project-management/REFERENCES.md` → **Internal — Live Artefacts** (src/16-STORY-PLANS/, src/15-SPRINT-PLANS/, src/14-DECISIONS/) for supporting references.

Use this checklist to verify the story plan is complete before implementation begins.

## Prerequisites

- [ ] Story is slotted into a sprint (`src/15-SPRINT-PLANS/`)
- [ ] Every 02–13 spec relevant to this story is signed off
...
- [ ] Story is broken into phased implementation tasks mapped to `18-backend-code` →
      `19-api-code` → `20-frontend-code`
...
- [ ] Plan saved to `src/16-STORY-PLANS/STORY-PLAN-US###-<descriptor>.md`
- [ ] Row added to `src/16-STORY-PLANS/CONTEXT.md` → Plans Index, with Status
- [ ] Driving user story (`src/02-STORIES/US###.md`) updated with a reference to this plan
- [ ] Ready to proceed to `project-management/workflows/18-backend-code/`
