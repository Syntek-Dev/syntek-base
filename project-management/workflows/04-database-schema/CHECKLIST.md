...
> **See** `project-management/REFERENCES.md` → **Internal — Guides** (gdpr/COMPLIANCE.md) · **Internal — Live Artefacts** (src/04-DATABASE/) for supporting references.
...
- [ ] Document saved at `project-management/src/04-DATABASE/DB-<FEATURE>-DD-MM-YYYY.md`
...
- [ ] Handed forward to `13-api-design/` (next design gate) and recorded as the prerequisite for
      `18-backend-code/`, which drives `code/workflows/03-database-migration/` — the migration is
