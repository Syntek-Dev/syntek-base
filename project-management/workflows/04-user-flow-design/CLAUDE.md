...
# CLAUDE.md — workflows/04-user-flow-design/
...
- **Routing:** run `STEPS.md` against `CHECKLIST.md`. Pre-code design phase — no hard
  safety gates apply. Feeds `workflows/06-component-designs/` and `07-wireframes/`.
...
- **Hand-written:** `USER-FLOW-<AREA>.md` in `src/04-USER-FLOW/`; `STEPS.md`/
