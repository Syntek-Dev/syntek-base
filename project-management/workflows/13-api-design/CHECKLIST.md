...
> **See** `project-management/REFERENCES.md` → **Internal — Live Artefacts** (src/13-API-DESIGN/, src/13-API-DESIGN/PLANNING/) for supporting references.
...
- [ ] Document saved to `src/13-API-DESIGN/API-US###-<descriptor>.md`
