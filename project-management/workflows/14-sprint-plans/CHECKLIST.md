...
> **See** `project-management/REFERENCES.md` → **Internal — Guides** (SPRINT-PLANNING-GUIDE.md) · **External — Agile & Project Management** (MoSCoW, Definition of Done) · **Internal — Live Artefacts** (src/14-SPRINT-PLANS/) for supporting references.

## Execution Checklist

- [ ] GDPR review complete and documented for all in-scope stories
- [ ] Security checks complete with no unresolved HIGH/CRITICAL findings
- [ ] QA documents exist for all in-scope stories
- [ ] SEO documents exist for all in-scope stories
- [ ] API Design documents exists for all in-scope stories
...
- [ ] Sprint plan document created: `SPRINT-PLAN-##.md` in `project-management/src/14-SPRINT-PLANS/`
...
- [ ] Ready to proceed to `workflows/15-story-plans`
