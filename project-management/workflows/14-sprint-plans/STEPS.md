...
| Step      | Section                                                                               |
| --------- | ------------------------------------------------------------------------------------- |
| All steps | **Internal — Guides** → project-management/docs/SPRINT-PLANNING-GUIDE.md              |
| All steps | **External — Agile & Project Management** → MoSCoW prioritisation, Definition of Done |
| Artefacts | **Internal — Live Artefacts** → src/14-SPRINT-PLANS/                                  |
...
- `project-management/src/11-SEO` - SEO documents for all in-scope stories
- `project-management/src/12-API-DESIGN` - API Design documents for all in-scope stories
...
Create `project-management/src/14-SPRINT-PLANS/SPRINT-PLAN-##.md` with the following sections:
...
### Phase 1 — Backend
Stories: US###, US###
Workflows: 16-backend-code

### Phase 2 — API
Stories: US###, US###
Workflows: 17-api-code

### Phase 3 — Frontend
Stories: US###, US###
Workflows: 18-frontend-code

### Phase 4 — PR & Review
Workflows: 20-pr-and-review
