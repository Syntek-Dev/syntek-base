...
> **See** `project-management/REFERENCES.md` → **Internal — Guides** (QA-GUIDE.md) · **Internal — Live Artefacts** (src/10-QA/PLANNING/) for supporting references.
...
- [ ] `QA-US###-<DESCRIPTION>.md` created for every story in `project-management/src/10-QA/PLANNING/`
...
- [ ] Ready to proceed to `workflows/14-sprint-plans`
