...
- [ ] QA agent (`/syntek-dev-suite:qa-tester`) run for each story
- [ ] `QA-US###-<DESCRIPTION>.md` created for every story in `project-management/src/10-QA/`
...
- [ ] Ready to proceed to `workflows/13-sprint-plans`
