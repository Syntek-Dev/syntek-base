...
# CLAUDE.md — workflows/07-wireframes/
...
- **Concrete steps:** confirm a driving `US###` and its acceptance criteria → wireframe
  the agreed user flow (`src/04-USER-FLOW/`) starting at 360 px portrait and scaling up →
...
- **Hand-written:** wireframe files in `src/07-WIREFRAMES/`; `STEPS.md`/`CHECKLIST.md`
  updates.
