...
> **See** `project-management/REFERENCES.md` → **Internal — Guides** (SECURITY-GUIDE.md) · **External — Compliance & Legal** (OWASP Top 10, STRIDE, NIST CSF) · **Internal — Live Artefacts** (src/10-SECURITY/) for supporting references.
...
- [ ] Individual vulnerability reports created for all `CRITICAL` and `HIGH` findings in `project-management/src/10-SECURITY/VULNERABILITIES/`
...
- [ ] Ready to proceed to `workflows/11-qa-checks`
