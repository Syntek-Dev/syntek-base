...
| Step      | Section                                                                                        |
| --------- | ---------------------------------------------------------------------------------------------- |
| All steps | **Internal — Live Artefacts** → src/12-API-DESIGN/                                             |
| Planning  | **Internal — Live Artefacts** → src/12-API-DESIGN/PLANNING/ (save PLAN-\*.md design docs here) |
...
3. Proceed to `workflows/14-sprint-plans/` to include this story in the next sprint
