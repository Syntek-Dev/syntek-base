...
# CLAUDE.md — workflows/05-brand-guides/
...
- **Routing:** run `STEPS.md` against `CHECKLIST.md`. Design phase — no code safety
  gates. Four stages: ideate (Claude Design) → record (`src/05-BRAND-GUIDE/`) → present
...
- **Hand-written:** `BRAND-COLOURS.md`, `BRAND-TYPOGRAPHY.md`, `BRAND-SPACING.md`,
  `BRAND-LOGOS.md` in `src/05-BRAND-GUIDE/`; `STEPS.md`/`CHECKLIST.md` updates.
