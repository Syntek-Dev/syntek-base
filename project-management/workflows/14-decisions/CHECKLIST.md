...
> (src/14-DECISIONS/) · `src/14-DECISIONS/CLAUDE.md` (authoring rules) ·
> `src/14-DECISIONS/ADR-000-TEMPLATE.md` (the five-section scaffold) for supporting
> references.
...
- [ ] `src/14-DECISIONS/` was scanned for an existing ADR this one might supersede
...
- [ ] Ready to proceed to `workflows/15-sprint-plans/` and `workflows/16-story-plans/`
