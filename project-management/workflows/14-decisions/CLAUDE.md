...
# CLAUDE.md — workflows/14-decisions/
...
as an immutable `ADR-###-<TITLE>.md` in `src/14-DECISIONS/`, using
...
- **Routing:** run `STEPS.md` in order; the hard gates —
  `src/14-DECISIONS/CLAUDE.md` (immutability, monotonic indices) and
  ...
  `13-api-design`, or any 02–13 workflow) that surfaced the trade-off.
