...
> **See** `project-management/REFERENCES.md` → **External — Agile & Project Management** (User Story format) · **Internal — Live Artefacts** (src/01-STORIES/) for supporting references.
