...
```text
project-management/workflows/18-frontend-code/
...
- `project-management/workflows/17-api-code/` — the Django Ninja API must exist before this workflow
- `project-management/workflows/20-pr-and-review/` — follow this after frontend is tested
- `project-management/docs/SEO-CHECKLIST.md` — SEO requirements for all public-facing pages
- `project-management/src/11-SEO/` — existing SEO requirements for the feature area
