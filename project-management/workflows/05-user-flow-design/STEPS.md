...
| Step      | Section                                                                                       |
| --------- | --------------------------------------------------------------------------------------------- |
| All steps | **Internal — Live Artefacts** → src/05-USER-FLOW/                                             |
...
This feeds the GDPR compliance review in `project-management/workflows/09-gdpr-compliance/`.

### Step 5 — Document the Flow

> **Model:** opus

Save the flow document to `project-management/src/05-USER-FLOW/`.
