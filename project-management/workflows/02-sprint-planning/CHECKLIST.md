...
> **See** `project-management/REFERENCES.md` → **External — Agile & Project Management** (MoSCoW, Definition of Done) · **Internal — Live Artefacts** (src/02-SPRINTS/) for supporting references.
...
- [ ] Sprint plan committed and pushed
- [ ] Team has reviewed and agreed on scope
