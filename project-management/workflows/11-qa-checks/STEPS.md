...
| Artefacts | **Internal — Live Artefacts** → src/11-QA/PLANNING/ (save QA plans here) |
...
For each wireframe in `project-management/src/08-WIREFRAMES/`, identify:
...
`US###.md` in `project-management/src/02-STORIES/` before sprint planning.
