...
```text
project-management/workflows/13-sprint-plans/
...
- Sprint plan documents live in `project-management/src/13-SPRINT-PLANS/`
...
- `project-management/src/13-SPRINT-PLANS/` — sprint plan documents
