...
| ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| shapes scope, a requirement, or a still-open question in a feature plan | the `### Requirements` / `### Open Questions` sections of the story plan in `project-management/src/15-STORY-PLANS/` |
...
| sets observable behaviour for a story                                   | the Gherkin `## Acceptance Criteria` of `project-management/src/01-STORIES/US###.md`                                 |
...
This is the design-work default: the `planner`, `database`, `backend`, and `user-story`
agents open architecture / schema / API / story work with a grill-with-docs pass before
...
- `project-management/workflows/03-database-schema/` — schema design
- `project-management/workflows/12-api-design/` — API contract design
- `project-management/workflows/13-decisions/` — ADR options
- `project-management/workflows/15-story-plans/` — story approach and phasing
...
- `.claude/agents/planner.md`, `database.md`, `backend.md`, `user-story.md` — the callers.
