...
| [`skill-authoring/FRONTMATTER.md`](skill-authoring/FRONTMATTER.md)     | The six specification fields and their constraints, the four runtime keys admitted here, `metadata.skills` as a checkable register, the routing `skills:` key a guide writes and the citation it obliges back, what is declined and why |
