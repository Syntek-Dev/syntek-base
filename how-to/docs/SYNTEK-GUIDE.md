...
- All feedback and metrics are stored in your project's `project-management/src/` folder
...
[how-to/src/CONTRIBUTING/MARKDOWN-ALL-IN-ONE.md](../../how-to/src/CONTRIBUTING/MARKDOWN-ALL-IN-ONE.md).
