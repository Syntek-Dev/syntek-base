...
- `code/workflows/10-debug/` — code-logic debugging (after environment confirmed healthy)
- `code/workflows/09-debugging-with-logs/` — observability tools for staging/prod issues
