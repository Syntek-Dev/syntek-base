...
| [AGENTS.md](AGENTS.md)                                         | Codex entry point into the shared project instructions            |
| [.ai/INSTRUCTIONS.md](.ai/INSTRUCTIONS.md)                     | Shared context loading, skill aliases and host-specific behaviour |
...
| [code/docs/GATE-REPORTING.md](code/docs/GATE-REPORTING.md)                                                   | **"Could not look" is never reported as "looked, and it was clean"** — absent tool vs absent surface, and the idiom each gate family uses (enforced at review, not by a script)                             |
| [code/docs/FORWARD-VOICE.md](code/docs/FORWARD-VOICE.md)                                                     | **What a shipped document may claim about a tree it will be read in** — the register for "absent here, present downstream" and the `template-only` token for the reverse (gate: `audits/doc-references.sh`) |
...
| [code/docs/TESTING.md](code/docs/TESTING.md)                                                                 | Coverage floors, test structure, mocking strategy — plus the `story` marker each test declares (generator: `tests/test-record.sh` · warn-only audit: `audits/story-markers.sh`)                             |
...
| 01 — Implement story     | [code/workflows/01-implement-story/CONTEXT.md](code/workflows/01-implement-story/CONTEXT.md)         |
...
| 01 — Feature map                  | [project-management/workflows/01-feature-map/CONTEXT.md](project-management/workflows/01-feature-map/CONTEXT.md)                                   |
...
all three build rows name the same pass — entered at `18`, closed at `20`, never re-run per phase.
